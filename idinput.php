...
<body>
    ...
    <!-- Main[Start] -->
    <form method="post" action="idinput_insert.php">
        <div class="jumbotron">
            <fieldset>
                <legend>ID登録</legend>
                <label id="name">Name：<input type="text" name="name"></label><br>
                <label id="lid">ID：<input type="text" name="lid"></label><br>
                <label id="lpw">Password：<input type="text" name="lpw"></label><br>
